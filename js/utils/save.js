	...
	for (item in data) {
		if (data[item] == null) {
			...
			if (!NaNalert) {
				...
				NaNalert = true;
				alert("Invalid value found in player, named '" + item + "'. Please DM username 'coolppl_idk' on Discord about the problem. You can refresh the page, and you might be un-NaNed.")
				return
			}
		}
